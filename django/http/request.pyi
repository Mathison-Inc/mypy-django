...
from django.core.files import uploadhandler as uploadhandler, uploadedfile as uploadedfile
from django.utils.datastructures import MultiValueDict as MultiValueDict, ImmutableList as ImmutableList
from django.urls import ResolverMatch as ResolverMatch
...
@overload
def bytes_to_text(s: bytes, encoding: str) -> Optional[str]: ...
@overload
def bytes_to_text(s: str, encoding: str) -> Optional[str]: ...
@overload
def bytes_to_text(s: None, encoding: str) -> Optional[str]: ...
